...
<section class="features">
    <div class="container">
        <h2 style="text-align: center; font-size: 2.5rem; color: var(--accent-cyan); margin-bottom: 3rem; text-shadow: 0 0 10px var(--accent-cyan);">
...
<!-- CTA Section -->
<section style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--primary-dark) 0%, var(--secondary-dark) 100%); text-align: center;">
    <div class="container">
        ...
        <a href="/pages/booking_wizard.php?lang=<?php echo $current_lang; ?>" class="btn-neon btn-orange" style="font-size: 1.1rem; padding: 15px 40px;">
